          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Push Notication</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form  action="<?php echo base_url() ?>insert/push-notification" method="post"  class="form-horizontal form-label-left" enctype="multipart/form-data">
                      <!-- <div class="form-group">
                        <div class="col-md-8 col-md-offset-2 col-sm-8 col-xs-12">
                          <label class="control-label" for="file">Image<span class="required">*</span>
                        </label>
                        <input type="file" id="file" required="required" class="form-control col-md-7 col-xs-12" name="psh_image" accept="image/jpeg, image/png ,image/jpg" >
                      </div>
                    </div> -->
                    <div class="form-group">
                      ...
                      <input type="hidden" name="itemid" value="<?php echo random_string('alnum','16'); ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-8 col-md-offset-1 col-sm-6 col-xs-12">
                      <label for="agent" class="control-label">Agent </label>
                      <select class="form-control" name="agent[]" required="required"
                        id="agent" class="form-control col-md-7 col-xs-12" multiple style="height: 200px;">
                        <option value="">-----Select-----</option>
                        <?php

                        foreach ($agent as $key => $value) { ?>

                        <option value="<?php echo $value->agent_id  ?>"><?php echo $value->agent_name.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -&nbsp;&nbsp;  '.$value->agent_phone ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-8 col-md-offset-1 col-sm-8 col-xs-12">
                      ...
                      <input type="text" id="link" class="form-control col-md-7 col-xs-12" name="link">
                      <input type="hidden" name="itemid" value="<?php echo random_string('alnum','16'); ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-10 col-md-offset-1 col-sm-8 col-xs-12">
                      <label class="control-label" for="editor">Description <span class="required">*</span> </label>
