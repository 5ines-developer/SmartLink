                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <table class="table viedet" style="margin-bottom: 0px;">
                                                ...
                                                <tr>
                                                    <th>Reward Points</th>
                                                    <td><?php echo (!empty($referal['reward_points']))?$referal['reward_points']:'---'  ?></td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<?php echo base_url() ?>approve-referal" method="post" id="referal-approve"
                                        ...
                                        <input type="hidden" name="referalid"value="<?php echo (!empty($referal['uniq']))?$referal['uniq']:''  ?>">
                                        <input type="hidden" name="noti_to"value="<?php echo (!empty($referal['agent_id']))?$referal['agent_id']:''  ?>">
                                        <input type="hidden" name="reward_expiry"value="<?php echo (!empty($reward['reward_expiry_date']))?$reward['reward_expiry_date']:''  ?>">
                                    </div>
                                    ...
                                    class="form-control col-md-7 col-xs-12" name="rewrd" value="<?php echo (!empty($reward['reward_points']))?$reward['reward_points']:''  ?>" readonly> </div>
                                </div>
